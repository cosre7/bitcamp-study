...
public class Exam03 {
  ...
  public static void main(String[] args) throws Exception {
    ...
    //    Class clazz = Class.forName("com.eomcs.reflect.ex01.Exam03$A"); // 유지보수 측면에서 더 좋다

    System.out.println("----------------------------------");

    // 자바의 모든 클래스는 "class"라는 특별한 스태틱 변수를 갖고 있다. // 내장된 변수
    ...
    // 클래스 정보를 얻기 위해 A.class 처럼 class라는 스태틱 변수를 사용하는 것이 
    // forName()을 호출하는 것 보다 안 좋은 이유?
    ...
    Class clazz2 = String.class; // 클래스 파일이 아니다!!! 클래스 정보가 들어있는 내장변수이다!

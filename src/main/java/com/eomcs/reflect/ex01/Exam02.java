...
public class Exam02 {
  ...
  public static void main(String[] args) throws Exception {
    ...
    //     => 바깥 클래스가 로딩되었다고 중첩 클래스가 자동으로 로딩되는 것은 아니다. // B가 로딩됬다고 C가 로딩되지 않는다!

    //    Class.forName("com.eomcs.reflect.ex01.B$C");
    // => 중첩 클래스는 "바깥클래스명$중첩클래스명" 형식의 이름을 갖는다.
    //    Class.forName("com.eomcs.reflect.ex01.Exam02.A"); // 에러!
    // => 스태틱 중첩 클래스를 로딩할 때는 바깥 클래스를 로딩하지 않는다.
    ...
    //    com.eomcs.reflect.ex01.B$C obj; // 에러!
    //    com.eomcs.reflect.ex01.B.C obj; // 로딩되지 않는다.

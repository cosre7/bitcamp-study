...
public class Exam01 {
  ...
  public static void main(String[] args) throws Exception {
    // 클래스 로딩
    // => 클래스가 로딩되어 있지 않다는 조건
    // 1) 클래스의 스태틱 멤버(변수,메서드)를 사용할 때 -> 바깥 클래스도 같이 로딩된다.
    ...
    //    arr = new A[100]; // 레퍼런스 배열도 마찬가지로 클래스 로딩과 상관없다. // A 인스턴스 주소를 저장할 레퍼런스를 100개 만들어라!

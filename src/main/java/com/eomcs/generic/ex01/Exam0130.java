...
public class Exam0130 {
  ...
  public static <What> What echo(What obj) {
    // What은 클래스 이름이 아니다! 라고 알려주는게 <What>
    // <What>이 있으면 What obj 대신 String obj가 입력되면 What echo 대신 String echo가 된다
    return obj;
  }
  ...
  public static void main(String[] args) {
    ...
    // 파라미터로 String을 받음 -> String 입력 -> 리턴 타입은 String
    Date obj2 = echo(new Date());
    Calendar obj3 = echo(Calendar.getInstance());
    // 메소드가 넘어가는 것이 아니다!
    // 메소드가 호출 된 후에 리턴값이 넘어가는 것!
    // Calendar.getInstance() 를 통해서 Calendar 리턴값을 받을 수 있다
    // -> 이 Calendar 리턴값이 echo의 파라미터로 넘어간다
    // => 때문에 What echo의 리턴값은 Calendar가 된다.
    File obj4 = echo(new File("okok"));
    Integer obj5 = echo(Integer.valueOf(100));
  }
}

// # 제네릭의 타입 파라미터 (위의 <What>) 로 많이 사용하는 이름

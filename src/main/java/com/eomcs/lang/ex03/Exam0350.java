...
//## 실습
//1) 컴파일하기
//- $ javac -d bin/main -encoding UTF-8 src/main/java/com/ohoracs/basic/ex03/Exam0350.java
//
//2) 클래스 파일로 부동소수점 값 확인하기
//- Exam0350.class 파일을 hexdump 플러그인으로 출력한다. -> 16진수의 형태로 만들어주는 플러그인
...
//      - 계산이 멈추어지지 않고 반복되는 경우에 값이 변형되어 저장되는 오류가 발생된다.
// - 예: 0.375(10진수)
// 0.375 * 2 = 0.75  --> 0
// 0.75 * 2  = 1.5   --> 1
// 0.5 * 2   = 1.0   --> 1

...
public class Exam0210 {
  public static void main(String[] args) throws Exception {
    ...
    // 파라미터로 받은 문자열이 인스턴스 문자열에 존재하는지 확인 -> 포함되어 있는지
    ...
    System.out.println(s1.equals("aaa")); // 값을 비교하는 것 -> false
    System.out.println(s1.equals("Hello")); // 값을 비교하는 것 -> true
    System.out.println(s1 == "Hello"); // 주소를 비교하는 것 -> false
    System.out.println("-------------------------------------");
    ...
    // 특정 인스턴스 변수를 받지 않고 파라미터만으로 처리하는 것

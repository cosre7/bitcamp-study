...
public class Exam0310 {
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      // 예외에 대한 상세 정보 출력
      e.printStackTrace(); // e객체를 통해 printStackTrace() 메서드 호출 
      // printStackTrace(): 어느 부분에서 예외가 발생했는지 추적
    }
...
// 예외 클래스 계층도
// [java.lang.Throwable]
//     ㄴ java.lang.Error : 시스템 예외 -> 손댈 수 없다 => 안내메시지 출력, 로그 기록 남기고 종료
//     ㄴ java.lang.Exception : 애플리케이션 예외 -> 손댈 수 있다
//

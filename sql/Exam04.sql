...
- 모든 테이블은 primary key가 있어야만 한다.

```
/* 게시판 테이블 */
create table test1(
  no int not null primary key auto_increment, /* (not null 생략가능)*/
  title varchar(255) not null,
  content text,
...
- 삭제할 때는 자식의 자식의 자식의 자식의 자식의 자식부터 지우고 점차적으로 지워 올라가야 한다!!
